...
--comando para retornar (nota,disciplina,aluno_nome) ordem notas ASC.
SELECT
    nota,
    disciplina,
    aluno_nome
...
-- Alunos da disciplina de "Matematica" com notal >= 70
...
FROM
    notas_alunos
WHERE
    disciplina = 'Matematica' AND nota >= 70;

-- Alunos da disciplina de 'Portuges' com nota > 70 --
SELECT
    aluno_nome,
    disciplina,
    nota
FROM
    notas_alunos
WHERE
    disciplina = 'Portugues' AND nota >= 70;
